...
public class HelloPhysics extends SimpleApplication implements PhysicsCollisionListener
{
 ...
 private boolean flag =false;
  ...
  public void displayGumball()
  {
      ...
      if(gumball_count==4 ) gumball_count++;
  ...
  private ActionListener actionListener = new ActionListener() {
    ...
    public void onAction(String name, boolean keyPressed, float tpf) {
      ...
      if ((name.equals("shoot") && !keyPressed)&& ball_count<=5) {
        makeCannonBall();
      ...
      //  logger.log(Level.WARNING, "gumball count{0} !", new Object[]{gumball_count});
       ...
       //FACTORY pattern used to set the color of the ball
        BallMaterialFactory ballMaterialFactory = new BallMaterialFactory();
         ...
         Random random = new Random();
            for(int m=1;m<6;m++){
                int randomColor = random.nextInt(m);
                 if(randomColor==1)  ball_geo.setMaterial(ballMaterialFactory.getMaterial(1, assetManager));
                 else if(randomColor==2) ball_geo.setMaterial(ballMaterialFactory.getMaterial(2, assetManager));
                 else if(randomColor==3) ball_geo.setMaterial(ballMaterialFactory.getMaterial(3, assetManager));
                 else if(randomColor==4) ball_geo.setMaterial(ballMaterialFactory.getMaterial(4, assetManager));
                 else   ball_geo.setMaterial(ballMaterialFactory.getMaterial(5, assetManager));
